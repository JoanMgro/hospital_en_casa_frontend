<script setup>
    ...
    import ActualizarFamiliar from '../components/ActualizarFamiliar.vue';
    ...
    <template>
        ...
        <div class="header_home_familiar">
            <div class="top_header">
                <div class="user"><span><img src="../assets/images/user_avatar.svg" alt=""></span><span>{{currentUser.nombres_familiar}}</span></div>
            ...
            <div class="navbar_home_familiar">
                ...
                <button @click="verHistoria" class="botones_aux_view">Ver Historia paciente</button>

            </div>
        </div>
        <div class="components">

            <ActualizarFamiliar v-if="isActive.showCompUno" :currentData = "currentUser"/>
            <SignosVitalesInput v-if="isActive.showCompTres" :propsCurrentUser="currentUser.id_paciente" />
            <VerHistoriaClinicaPaciente v-if="isActive.showCompDos" :propsId ="currentUser.id_paciente"/>
